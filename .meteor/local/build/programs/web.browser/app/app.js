var require = meteorInstall({"app":{"accounts":{"template.LoginModal.js":function(){

///////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                           //
// app/accounts/template.LoginModal.js                                                                       //
//                                                                                                           //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                             //
                                                                                                             // 1
Template.__checkName("LoginModal");                                                                          // 2
Template["LoginModal"] = new Template("Template.LoginModal", (function() {                                   // 3
  var view = this;                                                                                           // 4
  return HTML.DIV({                                                                                          // 5
    "class": "login-modal"                                                                                   // 6
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                             //
var myLogoutFunc = function myLogoutFunc() {                                                                 // 1
  FlowRouter.go('/');                                                                                        // 2
};                                                                                                           //
                                                                                                             //
AccountsTemplates.configure({                                                                                // 5
  // Behavior                                                                                                //
  onLogoutHook: myLogoutFunc,                                                                                // 7
  ...
  focusFirstInput: true,                                                                                     // 14
                                                                                                             //
  // Appearance                                                                                              //
  showAddRemoveServices: false,                                                                              // 17
...
AccountsTemplates.addFields([{                                                                               // 38
  _id: 'firstName',                                                                                          // 40
  type: 'text',                                                                                              // 41
  displayName: 'First Name',                                                                                 // 42
  required: true                                                                                             // 43
}, {                                                                                                         //
  _id: 'surname',                                                                                            // 46
  type: 'text',                                                                                              // 47
  displayName: 'Surname',                                                                                    // 48
  required: true                                                                                             // 49
}]);                                                                                                         //
///////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var AccountsUI = function (_Component) {                                                                     //
	...
	function AccountsUI(props, context) {                                                                       // 9
		...
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props, context));      //
                                                                                                             //
		_this._toggleLoginPanel = _this._toggleLoginPanel.bind(_this);                                             // 11
		_this.state = {                                                                                            // 12
		...
		return _this;                                                                                              //
                                                                                                             ...
                                                                                                             //
	AccountsUI.prototype.componentDidMount = function () {                                                      // 7
		function componentDidMount() {                                                                             //
			this.view = Blaze.render(Template.LoginModal, _reactDom2['default'].findDOMNode(this.refs.container));    // 18
		}                                                                                                          //
                                                                                                             //
		return componentDidMount;                                                                                  //
	}();                                                                                                        //
                                                                                                             //
	AccountsUI.prototype.compoentWillUnmount = function () {                                                    // 7
		function compoentWillUnmount() {                                                                           //
			Blaze.remove(this.view);                                                                                  // 23
		}                                                                                                          //
                                                                                                             //
		return compoentWillUnmount;                                                                                //
	}();                                                                                                        //
                                                                                                             //
	AccountsUI.prototype._toggleLoginPanel = function () {                                                      // 7
		function _toggleLoginPanel() {                                                                             //
			var newState = !this.state.loginPanelOn;                                                                  // 28
			this.setState({                                                                                           // 29
				loginPanelOn: newState                                                                                   // 30
			});                                                                                                       //
                                                                                                             //
			this.props.callBackLogin(newState);                                                                       // 33
		}                                                                                                          //
                                                                                                             //
		return _toggleLoginPanel;                                                                                  //
	}();                                                                                                        //
                                                                                                             //
	AccountsUI.prototype.render = function () {                                                                 // 7
		function render() {                                                                                        //
			console.log('State for LoginPanel in Account UI is :', this.state.loginPanelOn);                          // 39
			if (this.state.loginPanelOn) {                                                                            // 40
				var loginPanelClass = "";                                                                                // 41
			} else {                                                                                                  //
				var loginPanelClass = "hidden";                                                                          // 43
			}                                                                                                         //
                                                                                                             //
			return _react2['default'].createElement(                                                                  // 47
				...
				_react2['default'].createElement(                                                                        //
					...
					_react2['default'].createElement(                                                                       //
						'button',                                                                                              //
						{ className: 'cancel_action input_style ghost-button red_back', onClick: this._toggleLoginPanel },     //
						'Cancel'                                                                                               //
					)                                                                                                       //
				)                                                                                                        //
			);                                                                                                        //
...
var Header = function (_Component) {                                                                         //
	...
	function Header(props, context) {                                                                           // 7
		...
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props, context));      //
                                                                                                             //
		_this._callBackNav = _this._callBackNav.bind(_this);                                                       // 9
		_this._callBackLogin = _this._callBackLogin.bind(_this);                                                   // 10
                                                                                                             //
		_this.state = {                                                                                            // 12
			navButtonOn: _this.props.navButtonOn,                                                                     // 13
	...
	Header.prototype._callBackNav = function () {                                                               // 6
		function _callBackNav(data) {                                                                              //
			...
			this.setState({ navButtonOn: newState });                                                                 // 20
			this.props.callBackNav(newState);                                                                         // 21
		}                                                                                                          //
                                                                                                             //
		return _callBackNav;                                                                                       //
	}();                                                                                                        //
                                                                                                             //
	Header.prototype._callBackLogin = function () {                                                             // 6
		function _callBackLogin() {                                                                                //
			var newState = !this.state.loginPanelOn;                                                                  // 24
			this.setState({ loginPanelOn: newState });                                                                // 25
			console.log('LoginNewstate in Header(origin)', newState);                                                 // 26
			this.props.callBackLogin(newState);                                                                       // 27
		}                                                                                                          //
                                                                                                             //
		return _callBackLogin;                                                                                     //
	}();                                                                                                        //
                                                                                                             //
	Header.prototype.render = function () {                                                                     // 6
		function render() {                                                                                        //
			...
			return _react2['default'].createElement(                                                                  // 32
				...
				_react2['default'].createElement(_NavButton2['default'], { initialNavOn: this.props.navButtonOn, callBack: this._callBackNav }),
				_react2['default'].createElement(                                                                        //
					'nav',                                                                                                  //
...
var MainLayoutWrapper = function (_Component) {                                                              //
	...
	function MainLayoutWrapper(props, context) {                                                                // 9
		...
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props, context));      //
                                                                                                             //
		_this._callBackNav = _this._callBackNav.bind(_this);                                                       // 11
		_this._callBackLogin = _this._callBackLogin.bind(_this);                                                   // 12
		_this.state = {                                                                                            // 13
			navButtonOn: false,                                                                                       // 14
			loginPanelOn: false                                                                                       // 15
		};                                                                                                         //
		return _this;                                                                                              //
	}                                                                                                           //
                                                                                                             //
	MainLayoutWrapper.prototype._callBackNav = function () {                                                    // 8
		function _callBackNav(data) {                                                                              //
			var newState = data;                                                                                      // 20
			this.setState({ navButtonOn: newState });                                                                 // 21
		}                                                                                                          //
                                                                                                             //
		return _callBackNav;                                                                                       //
	}();                                                                                                        //
                                                                                                             //
	MainLayoutWrapper.prototype._callBackLogin = function () {                                                  // 8
		function _callBackLogin(data) {                                                                            //
			var newState = data;                                                                                      // 25
			this.setState({ loginPanelOn: newState });                                                                // 26
			console.log('response from child on LoginPanel', newState);                                               // 27
		}                                                                                                          //
                                                                                                             //
		return _callBackLogin;                                                                                     //
	}();                                                                                                        //
			...
			return _react2['default'].createElement(                                                                  // 32
				...
				_react2['default'].createElement(                                                                        //
					...
					_react2['default'].createElement(_Header2['default'], {                                                 //
						navButtonOn: this.state.navButtonOn,                                                                   // 36
						loginPanelOn: this.state.loginPanelOn,                                                                 // 37
						callBackNav: this._callBackNav,                                                                        // 38
						callBackLogin: this._callBackLogin }),                                                                 // 39
					_react2['default'].createElement(_NavSideBar2['default'], {                                             //
						navSideBarOn: this.state.navButtonOn,                                                                  // 43
						callBackLogin: this._callBackLogin }),                                                                 // 44
					...
					_react2['default'].createElement(_AccountsUI2['default'], {                                             //
						loginPanelOn: this.state.loginPanelOn,                                                                 // 50
						callBackLogin: this._callBackLogin }),                                                                 // 51
...
var NavSideBar = function (_Component) {                                                                     //
	...
	function NavSideBar(props, context) {                                                                       // 6
		...
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props, context));      //
                                                                                                             //
		_this._callBackLogin = _this._callBackLogin.bind(_this);                                                   // 8
                                                                                                             //
		_this.state = {                                                                                            // 10
		...
		return _this;                                                                                              //
                                                                                                             ...
                                                                                                             //
	NavSideBar.prototype._callBackLogin = function () {                                                         // 5
		function _callBackLogin(data) {                                                                            //
			var newState = !this.state.loginPanelOn;                                                                  // 16
			this.setState({ loginPanelOn: newState });                                                                // 17
			this.props.callBackLogin(newState);                                                                       // 18
		}                                                                                                          //
                                                                                                             //
		return _callBackLogin;                                                                                     //
	}();                                                                                                        //
	...
	NavSideBar.prototype.render = function () {                                                                 // 5
		function render() {                                                                                        //
			if (this.props.navSideBarOn) {                                                                            // 22
				navSideBarClass = "";                                                                                    // 23
			} else {                                                                                                  //
				navSideBarClass = "navHide";                                                                             // 25
			}                                                                                                         //
                                                                                                             //
...
var TestPageChild1 = function (_Component) {                                                                 //
	...
	function TestPageChild1(props) {                                                                            // 6
		...
		_this.state = {                                                                                            // 9
			switchOn: _this.props.initialPenelState                                                                   // 10
		};                                                                                                         //
		return _this;                                                                                              //
	}                                                                                                           //
                                                                                                             //
...
var TestPageChild3 = function (_Component) {                                                                 //
	...
	function TestPageChild3(props) {                                                                            // 6
		...
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props));               //
                                                                                                             //
		_this.state = {                                                                                            // 8
			switchOn: _this.props.initialPenelState                                                                   // 9
		};                                                                                                         //
		return _this;                                                                                              //
	}                                                                                                           //
                                                                                                             //
...
}],"Testpage.jsx":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits","react","meteor/ultimatejs:tracker-react","react-addons-css-transition-group","./TestPageChild1.jsx","./TestPageChild2.jsx","./TestPageChild3.jsx",function(require,exports){
...
var TestPage = function (_Component) {                                                                       //
	(0, _inherits3['default'])(TestPage, _Component);                                                           //
                                                                                                             //
	function TestPage(props) {                                                                                  // 8
		(0, _classCallCheck3['default'])(this, TestPage);                                                          //
                                                                                                             //
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props));               //
                                                                                                             //
		_this._callBackFunc = _this._callBackFunc.bind(_this);                                                     // 10
		_this._callBack2Func = _this._callBack2Func.bind(_this);                                                   // 11
		_this.state = {                                                                                            // 12
			panelOn: false,                                                                                           // 13
			panel2On: false                                                                                           // 14
		};                                                                                                         //
		return _this;                                                                                              //
                                                                                                             ...
                                                                                                             //
	TestPage.prototype._callBackFunc = function () {                                                            // 7
		...
		return _callBackFunc;                                                                                      //
                                                                                                             ...
                                                                                                             //
	TestPage.prototype._callBack2Func = function () {                                                           // 7
		...
		return _callBack2Func;                                                                                     //
                                                                                                             ...
                                                                                                             //
	TestPage.prototype.render = function () {                                                                   // 7
		function render() {                                                                                        //
			if (this.state.panelOn) {                                                                                 // 30
				var switchResponse = "lightblue_back";                                                                   // 31
			} else {                                                                                                  //
				var switchResponse = "red_back";                                                                         // 33
			}                                                                                                         //
			if (this.state.panel2On) {                                                                                // 35
				var switchResponse2 = "lightblue_back";                                                                  // 36
			} else {                                                                                                  //
				var switchResponse2 = "red_back";                                                                        // 38
			}                                                                                                         //
...
require("./app/accounts/template.LoginModal.js");
