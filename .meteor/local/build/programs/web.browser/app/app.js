...
Template["LoginModal"] = new Template("Template.LoginModal", (function() {                                    // 3
  var view = this;                                                                                            // 4
  return HTML.DIV({                                                                                           // 5
    classname: "login-modal"                                                                                  // 6
  }, "\n		", HTML.CENTER("\n\n		  ", HTML.Raw('<div class="message_box">Please type in your username and password to enter.</div>'), "\n		  ", Spacebars.include(view.lookupTemplate("atForm")), "\n		  \n		  ", HTML.Raw('<button classname="cancel_action input_style ghost-button red_back">Cancel</button>'), "\n				\n		"), "	\n	");
}));                                                                                                          // 8
                                                                                                              // 9
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
var AccountsUI = function (_Component) {                                                                      //
	...
	AccountsUI.prototype.componentDidMount = function () {                                                       //
		function componentDidMount() {                                                                              //
			this.view = Blaze.render(Template.LoginModal, _reactDom2['default'].findDOMNode(this.refs.container));     // 7
		}                                                                                                           //
                                                                                                              //
	...
	AccountsUI.prototype.compoentWillUnmount = function () {                                                     // 4
		...
		return compoentWillUnmount;                                                                                 //
                                                                                                              ...
                                                                                                              //
	function AccountsUI(props, context) {                                                                        // 15
		(0, _classCallCheck3['default'])(this, AccountsUI);                                                         //
                                                                                                              //
		var _this = (0, _possibleConstructorReturn3['default'])(this, _Component.call(this, props, context));       //
                                                                                                              //
		_this.state = {                                                                                             // 18
			loginPanelOn: true                                                                                         // 19
		};                                                                                                          //
		return _this;                                                                                               //
	}                                                                                                            //
                                                                                                              //
	AccountsUI.prototype._cancelLoginPanel = function () {                                                       // 4
		function _cancelLoginPanel() {                                                                              //
			console.log('Cancel Button clicked! loginPanelOn? ', this.state.loginPanelOn);                             // 24
			var newLoginPanelState = !this.state.loginPanelOn;                                                         // 25
                                                                                                              //
			this.setState({                                                                                            // 27
				loginPanelOn: newLoginPanelState                                                                          // 28
			});                                                                                                        //
			this.props.callbackParent(newLoginPanelState);                                                             // 30
		}                                                                                                           //
                                                                                                              //
	...
	AccountsUI.prototype.render = function () {                                                                  // 4
		function render() {                                                                                         //
			console.log('LoginPanelOn? ', this.state.loginPanelOn);                                                    // 34
			if (this.state.loginPanelOn) {                                                                             // 35
				var loginPanelClass = "";                                                                                 // 36
				console.log('Displaying loginPanel');                                                                     // 37
			} else {                                                                                                   //
				var loginPanelClass = "hideLoginPanel";                                                                   // 39
				console.log('Hiding loginPanel');                                                                         // 40
			}                                                                                                          //
                                                                                                              //
			return _react2['default'].createElement('span', { ref: 'container', loginPanelClass: 'loginPanelClass' });
		}                                                                                                           //
                                                                                                              //
		return render;                                                                                              //
	}();                                                                                                         //
...
}],"LoginModal.js":function(){

////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//                                                                                                            //
// app/accounts/LoginModal.js                                                                                 //
//                                                                                                            //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                              //
Template.LoginModal.events({                                                                                  // 1
	'click .close-login': function () {                                                                          // 2
		function clickCloseLogin() {                                                                                // 2
			Session.set('nav-toggle', '');                                                                             // 3
			console.log('Button clicked!');                                                                            // 4
		}                                                                                                           //
                                                                                                              //
		return clickCloseLogin;                                                                                     //
	}()                                                                                                          //
});                                                                                                           //
////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
}],"MainLayoutWrapper.jsx":["babel-runtime/helpers/classCallCheck","babel-runtime/helpers/possibleConstructorReturn","babel-runtime/helpers/inherits","react","./NavButton.jsx","../accounts/AccountsUI.jsx","./NavSideBar.jsx","./MainContentSection.jsx","./Footer.jsx",function(require,exports){
...
require("./app/accounts/LoginModal.js");
