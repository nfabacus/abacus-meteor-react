...
Meteor.methods({                                                                                                      // 1
	...
	registerUserInfo: function () {                                                                                      // 31
		function registerUserInfo(userInfo) {                                                                               //
			check(userInfo, Object);                                                                                           // 32
			if (Meteor.email) {                                                                                                // 33
				throw new Meteor.Error('Email already registered');                                                               // 34
			}                                                                                                                  //
                                                                                                                      //
			Accounts.createUser({                                                                                              // 37
				username: userInfo.username,                                                                                      // 38
				password: userInfo.password,                                                                                      // 39
				email: userInfo.email,                                                                                            // 40
				firstname: userInfo.firstname,                                                                                    // 41
				surname: userInfo.surname                                                                                         // 42
                                                                                                                      //
			}, function (err) {                                                                                                //
				if (err) {                                                                                                        // 45
					console.log(err);                                                                                                // 46
